...
//replace {API key} with API key
async function get_data() {
  var response = await fetch("https://api.openweathermap.org/data/3.0/onecall?lat=21.3099&lon=157.8581&units=metric&appid={API key}");
